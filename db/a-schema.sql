...
CREATE TABLE IF NOT EXISTS `ICS199Team1DB`.`customer_order` (
  ...
  `bill_prov_id` VARCHAR(2) NULL,
  `bill_country_id` VARCHAR(2) NULL COMMENT 'billing country',
  ...
  `ship_prov_id` VARCHAR(2) NULL,
  `ship_country_id` VARCHAR(2) NULL COMMENT 'shipping country',
...
-- -----------------------------------------------------
-- Table `ICS199Team1DB`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ICS199Team1DB`.`country` ;

CREATE TABLE IF NOT EXISTS `ICS199Team1DB`.`country` (
...
-- -----------------------------------------------------
-- Table `ICS199Team1DB`.`province`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ICS199Team1DB`.`province` ;

CREATE TABLE IF NOT EXISTS `ICS199Team1DB`.`province` (
  ...
  CONSTRAINT `fk_province_country`
    ...
    REFERENCES `ICS199Team1DB`.`country` (`country_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
